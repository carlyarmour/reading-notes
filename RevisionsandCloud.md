...
There is an alternative to making changes directly on GitHub by copying or 'cloning' a repository onto my computer, then using the Terminal and Visual Studio (VS) Code to make the wanted changes.
